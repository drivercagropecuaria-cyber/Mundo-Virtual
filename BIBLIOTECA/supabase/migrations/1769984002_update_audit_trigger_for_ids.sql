-- Migration: update_audit_trigger_for_ids
-- Ajusta o trigger de auditoria para colunas atuais
...
DECLARE
  ...
  new_val TEXT;
  field_name TEXT;
  important_fields TEXT[] := ARRAY['titulo', 'status_id', 'area_fazenda_id', 'tema_principal_id', 'responsavel', 'arquivo_url'];
BEGIN
